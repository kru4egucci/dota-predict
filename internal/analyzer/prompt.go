...
ВАЖНО: Ты ОБЯЗАН выбрать фаворита. Итоговая вероятность НЕ МОЖЕТ быть 50/50. Даже при минимальном преимуществе одной из сторон — укажи её как фаворита. Поле "winner" ОБЯЗАТЕЛЬНО должно содержать название одной из команд.
